...
from gmsh_util import create_box_mesh, plot_mesh

if __name__ == '__main__':
    converged_msf = 3
    # converged_msf_adapt = 1.5
    converged_msf_adapt = 3
    converged_dt = 0.05
    ...
    temperatures = nr_iterative_rect(nodecoords, ele_con, np.array([[100,25]], dtype = np.float32),
                                            theta_init, dt = converged_dt, t_final =t_final+1e-3,
                                            type="transient", mode="phase_change")
